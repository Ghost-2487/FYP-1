...
# Builds a LSTM model with a hybrid embedding approach.
def build_lstm(vocab_size, max_length, num_classes, embedding_matrix=None,
    ...
    # Higher Capacity LSTM
    x = LSTM(units=lstm_units, dropout=0.1, return_sequences=False)(x)
...
plt.legend()
plt.savefig(SCRIPT_DIR / "lstm_training_history.png", dpi=150, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(SCRIPT_DIR / "lstm_confusion_matrix.png", dpi=150, bbox_inches='tight')
plt.show()
...
plt.title('ROC Curve — LSTM', fontsize=14, fontweight='bold', pad=20)
plt.legend(loc='lower right', fontsize=11)
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / "lstm_roc_curve.png", dpi=150, bbox_inches='tight')
plt.show()
...
plt.title('Precision-Recall Curve — LSTM', fontsize=14, fontweight='bold', pad=20)
plt.legend(loc='lower left', fontsize=11)
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / "lstm_pr_curve.png", dpi=150, bbox_inches='tight')
plt.show()
...
def save_dashboard_json():
    ...
    with open(SCRIPT_DIR / "lstm_sentiment140_dashboard.json", 'w') as f:
        json.dump(dashboard, f, indent=2)
    print('✅ Dashboard JSON saved → lstm_sentiment140_dashboard.json')
